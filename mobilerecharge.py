...
A telecom company wants to provide customers with mobile recharge services.

The system should allow users to select plans and generate recharge receipts.
...
==================================================
Customer Name : Logan
Plan Selected : Unlimited 84 Days
Amount Paid   : ₹799
Status        : SUCCESSFUL"""
